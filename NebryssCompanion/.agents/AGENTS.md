...
6. **No Automatic Builds**: Do NOT run build commands (`ng build`, `npm run build`, etc.) automatically after making changes. Only perform builds when explicitly requested by the user.
