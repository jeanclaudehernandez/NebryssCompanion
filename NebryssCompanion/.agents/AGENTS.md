...
8. **Campaign Session Management & Entity Tagging**:
   ...
   - When concluding sessions: Fetch the latest session, ask debrief questions about exploration, battles, choices, and NPC interactions, synthesize the conclusion draft with entity ID tags in chat, await explicit approval in chat, and update MongoDB upon approval.
